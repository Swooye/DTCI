...
import QuestionnaireEditor from './pages/assessment/QuestionnaireEditor'
import QuestionBank from './pages/assessment/QuestionBank'
import GeneTypeManagement from './pages/assessment/GeneTypeManagement'
            ...
            <Layout>
              ...
              <Content className="main-content">
                <Routes>
                  ...
                  <Route path="/assessment/questionnaire/create" element={<QuestionnaireEditor />} />
                  <Route path="/assessment/questionnaire/edit/:id" element={<QuestionnaireEditor />} />
                  <Route path="/assessment/question-bank" element={<QuestionBank />} />
                  <Route path="/assessment/gene-type" element={<GeneTypeManagement />} />
